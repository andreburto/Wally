...
// Global constants
define("WALLY_PATH", dirname(__FILE__));
define("WWW_PATH", "/www/");
...
include_once(ELEARN_PATH . "Query2.php");
include_once(ELEARN_PATH . "WallyTables.php");
include_once(ELEARN_PATH . "WallyQuery2.php");

// Include the individual table objects
foreach(glob(ELEARN_PATH.TBL_DIR.'*.php') as $tbl) { include_once($tbl); }
...
foreach(glob(ELEARN_PATH.FNC_DIR.'*.php') as $fnc) { include_once($fnc); }
